...
- [Sprint 1: セキュリティ修正 + コード品質向上](#-sprint-1-セキュリティ修正--コード品質向上-完了)
- [Sprint 2: UX改善の基盤](#-sprint-2-ux改善の基盤完了)
- [Sprint 3: パフォーマンス + リファクタ](#-sprint-3-パフォーマンス--リファクタ完了)
- [Sprint 4: エンゲージメント機能](#-sprint-4-エンゲージメント機能完了)
- [進捗状況](#-進捗状況)
