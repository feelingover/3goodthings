...
> **Note**: このファイルはプロジェクトの開発進捗記録を保持しています。
> 最新のプロジェクトガイドとベストプラクティスは [.claude/CLAUDE.md](.claude/CLAUDE.md) を参照してください。

## クイックリファレンス

- **プロジェクトガイド**: [@.claude/CLAUDE.md](.claude/CLAUDE.md)
- **開発履歴**: [@.claude/progress.md](.claude/progress.md)
- **システム設計**: [@.claude/rules/architecture.md](.claude/rules/architecture.md)
- **セットアップ**: [@.claude/rules/development.md](.claude/rules/development.md)
